...
use app\model\mxq_order as MxqOrderModel;
use app\ctrl\admin\BaseController;
use app\validate\IDMustBeRequire;
use app\validate\DelValidate;

class mxq_order extends BaseController{
	
	public $mxq_order_M;
	public function __initialize(){
		$this->mxq_order_M = new MxqOrderModel();
	}
	...
	public function lists()
	{
		...
		$data=$this->mxq_order_M->lists_sort($page,$page_size,$where,$order);
		...
		$count = $this->mxq_order_M->new_count($where);
        $res['all_num'] = $count;
