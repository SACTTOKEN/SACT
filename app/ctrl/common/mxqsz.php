...
use app\model\mxqsz as UxqszModel;
use app\ctrl\admin\BaseController;
use app\validate\IDMustBeRequire;
use app\validate\DelValidate;
use app\validate\UxqszValidate;

class mxqsz extends BaseController{
	
	public $mxqsz_M;
	public function __initialize(){
		$this->mxqsz_M = new UxqszModel();
	}
	...
	public function saveadd(){
		(new UxqszValidate())->goCheck('scene_saveadd');
		$data = post(['title','ljrd','mtsc','gmid']);
	...
	{	
		(new UxqszValidate())->goCheck('scene_saveedit');
		$id = post('id');	
    	$data = post(['title','ljrd','mtsc','gmid']);
