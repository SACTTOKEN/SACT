...
class JsApiPay
{
	...
	public function GetOpenid($code)
	{
		...
		if (!$code){
			//触发微信返回code码
			$baseUrl = urlencode('http://'.cc('web_config','api').'/common/wx/wx_pay');
	 ...
	 */
	public function GetJsApiParameters($UnifiedOrderResult,$setting)
	{
		...
		$jsapi->SetPackage("prepay_id=" . $UnifiedOrderResult['prepay_id']);
		$config = new WxPayConfig();
		$jsapi->SetPaySign($jsapi->MakeSign_app($config,true,$UnifiedOrderResult['prepay_id']));
		}
