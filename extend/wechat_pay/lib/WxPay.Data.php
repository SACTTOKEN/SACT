...
class WxPayDataBase
{
	...
	**/
	 ...
	 */
	public function MakeSign_app($config, $needSignType = true,$prepay_id)
	{
		if($needSignType) {
		...
		$string="appid=".$this->values['appId']."&noncestr=".$this->values['nonceStr']."&package=Sign=WXPay&partnerid=".$config->GetMerchantId()."&prepayid=".$prepay_id."&timestamp=".$this->values['timeStamp']."&key=".$config->GetKey();
